...
namespace MultiVendorRestaurantManagement.Infrastructure.Migrations
{
    ...
    [Migration("20200506001147_ChangedVariantsAndAddOnToOwnedType")]
    partial class ChangedVariantsAndAddOnToOwnedType
    {
            ...
            modelBuilder.Entity("MultiVendorRestaurantManagement.Domain.Foods.Food", b =>
                {
                    ...
                    b.OwnsMany("MultiVendorRestaurantManagement.Domain.Foods.AddOn", "AddOns", b1 =>
                        {
                            b1.Property<long>("FoodId")
                                .HasColumnType("bigint");
                            ...
                            b1.Property<string>("DescriptionEng")
                                .HasColumnType("nvarchar(max)");
                    ...
                    b.OwnsMany("MultiVendorRestaurantManagement.Domain.Foods.Variant", "Variants", b1 =>
                        {
                            b1.Property<long>("FoodId")
                                .HasColumnType("bigint");
